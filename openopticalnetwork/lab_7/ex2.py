...
def LOGO(WDM_data, SyS_Line, P_in=1):
	...
	return 10*log10(1/ISNRab), power_v
...
snr,OI_power = LOGO(data["SI"][0], line ) #, 10**((power-30)/10))
print("Optimal Input Power is : ",OI_power[0], "[dBm] and maximum SNR is :", snr, "[dB]")
...
print("Maximum SNR is ",max_snr," and optimal input power ",opt_pwr, "dBm")
